 ...
 function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-zinc-950 p-4 relative overflow-hidden">
      ...
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-fuchsia-600/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-zinc-900/40 backdrop-blur-md border border-zinc-800/80 p-8 rounded-3xl shadow-2xl animate-in fade-in zoom-in-95 duration-300">
        ...
        {justRegistered && !error && (
          <div className="mb-5 p-3.5 bg-emerald-950/20 border border-emerald-900/40 rounded-xl flex items-center gap-3 text-xs text-emerald-200 animate-in fade-in duration-300">
